...
const Footer = () => {
  return (
   ...
   <div className="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
     <div className="p-5">
       <h3 className="font-bold text-xl text-indigo-600">UZUM MARKET</h3>
       <button className="rounded-lg px-4 py-2 bg-gray-600 text-gray-100 hover:bg-gray-700 duration-300 mt-2">Gooogle Play</button>
     </div>
      <div className="p-5">
